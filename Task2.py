...
arr = list()
for i in range(n):
    x = int(input('Введиет кол-во ягод на каждом кусте: '))
    arr.append(x)

#Решение с максимальным количеством на всей градке
...
# Решение с количеством от заданного куста
  
y = int(input('Введите номер куста: '))
print(arr[y-1] + arr[y] + arr[y+1])
